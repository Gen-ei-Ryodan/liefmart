...
class TiktokImport implements ToCollection, WithMultipleSheets
{
    protected $platform;
    ...
    /**
     * Cari baris header dalam data dengan pendekatan yang lebih fleksibel untuk TikTok
     *
     * @return int|bool
     */
    ...
    /**
     * Mapping kolom dari header dengan toleransi tinggi untuk berbagai format TikTok
     *
    ...
    protected function parseDate($dateStr)
    {
        ...
        try {
            ...
            // For TikTok, prioritize d/m/Y format (day/month/year)
    ...
    protected function recordBarangKeluar($orderItem, $stock, $quantity)
    {
        try {
            ...
            BarangKeluar::create([
                ...
                'catatan' => "Penjualan online tiktok - Order #{$orderItem->order->order_number}",
