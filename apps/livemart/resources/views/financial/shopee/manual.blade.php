        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('finance.shopee.index') }}" class="text-decoration-none">Keuangan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Input Manual</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('finance.shopee.index') }}" class="btn btn-outline-primary rounded-pill px-4">
