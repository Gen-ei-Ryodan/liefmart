...
<div class="container-fluid py-3 animate__animated animate__fadeIn animate__faster">
                    ...
                    <div>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <li><a class="dropdown-item" data-export="{{ route('finance.shopee.export.excel', request()->all()) }}"><i class="far fa-file-excel me-2"></i>Excel</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 table-striped" id="shopeeTransactionsTable">
                    <thead class="table-light">
                        <tr>
                                ...
                                <td class="text-end fw-bold text-danger">
                                    @php
                                        $total_persentase = $persentase_diskon1 + $persentase_diskon2 + $persentase_diskon3 + 
                                                            $persentase_diskon4 + $persentase_diskon5 + $persentase_diskon6 + $persentase_diskon7 + $persentase_diskon8 + $persentase_diskon9 + $persentase_diskon10 + $persentase_diskon11 + $persentase_diskon12 + ($transaction->adjustment < 0 ? 
