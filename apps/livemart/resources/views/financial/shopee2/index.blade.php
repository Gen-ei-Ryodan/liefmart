...
<div class="container-fluid py-3 animate__animated animate__fadeIn animate__faster">
    ...
    <div class="card shadow mb-4">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-danger-soft">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('finance.shopee2.manual', ['order_id' => $order->id]) }}" class="btn btn-sm btn-primary">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 table-striped" id="shopee2TransactionsTable">
                    <thead class="table-light">
                        <tr>
...
<style>
    ...
    /* Table Styling */
    #shopee2TransactionsTable {
        border-collapse: separate;
        border-spacing: 0;
    }
    
    #shopee2TransactionsTable tr.order-header {
        background-color: rgba(236, 240, 255, 0.5);
    }
    
    #shopee2TransactionsTable tbody tr:hover {
        background-color: rgba(236, 240, 255, 0.7);
    }
    
    #shopee2TransactionsTable tbody tr td:first-child {
        border-left: 3px solid transparent;
    }
    
    #shopee2TransactionsTable tbody tr.order-header td:first-child {
        border-left: 3px solid #4e73df;
    }
    
    #shopee2TransactionsTable tr td {
        white-space: nowrap;
