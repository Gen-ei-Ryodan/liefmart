...
<div class="container-fluid py-3 animate__animated animate__fadeIn animate__faster">
                    ...
                    <div>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <li><a class="dropdown-item" data-export="{{ route('finance.tiktok2.export.excel', request()->all()) }}"><i class="far fa-file-excel me-2"></i>Excel</a></li>
                            </ul>
                        </div>
                        <form action="{{ route('finance.tiktok2.sync-order-dates') }}" method="POST" class="d-inline-block ms-2">
                            @csrf
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="tiktok2TransactionsTable">
                    <thead class="table-light">
                        <tr>
...
<style>
    ...
    /* Table Styling */
    #tiktok2TransactionsTable {
        border-collapse: separate;
        border-spacing: 0;
    }
    
    #tiktok2TransactionsTable tr.order-header {
        background-color: rgba(236, 240, 255, 0.5);
    }
    
    #tiktok2TransactionsTable tbody tr:hover {
        background-color: rgba(236, 240, 255, 0.7);
    }
    
    #tiktok2TransactionsTable tbody tr td:first-child {
        border-left: 3px solid transparent;
    }
    
    #tiktok2TransactionsTable tbody tr.order-header td:first-child {
        border-left: 3px solid #4e73df;
    }
    
    #tiktok2TransactionsTable tr td {
        white-space: nowrap;
