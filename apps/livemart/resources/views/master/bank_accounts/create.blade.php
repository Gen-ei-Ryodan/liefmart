...
<div class="container-fluid animate__animated animate__fadeIn animate__faster">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold mb-1 text-gradient">Tambah Rekening Bank</h1>
        ...
        <div class="card border-0 shadow-sm mb-4 rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <select class="form-select rounded-3 @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name" required>
                                ...
                                <option value="BTN" {{ old('bank_name') == 'BTN' ? 'selected' : '' }}>BTN (Bank Tabungan Negara)</option>
                        ...
                        <div class="mb-4 d-none" id="other_bank_group">
                            ...
                            <input type="text" class="form-control rounded-3" id="other_bank" placeholder="Masukkan nama bank">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-3 @error('account_number') is-invalid @enderror" id="account_number" name="account_number" value="{{ old('account_number') }}" placeholder="Contoh: 1234567890" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control rounded-3 @error('account_name') is-invalid @enderror" id="account_name" name="account_name" value="{{ old('account_name') }}" placeholder="Nama pemilik rekening" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control rounded-3 @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Contoh: Rekening operasional untuk penerimaan pembayaran customer">{{ old('description') }}</textarea>
