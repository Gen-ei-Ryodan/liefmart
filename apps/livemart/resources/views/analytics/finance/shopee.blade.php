...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h1 class="h3 mb-0 text-gray-800">Analytic Keuangan Shopee Lamourad</h1>
            <p class="text-muted small mb-0">Analisis data transaksi keuangan Shopee Lamourad</p>
        </div>
            ...
            <div class="btn-group shadow-sm" role="group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item" data-export="{{ route('analytics.finance.shopee.export', request()->all()) }}"><i class="far fa-file-excel me-2"></i>Excel</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="alert alert-info alert-dismissible fade show shadow-sm" role="alert">
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('finance.shopee.index') }}" class="btn btn-sm btn-outline-primary ms-3">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            @if(request()->has('from_date') || request()->has('to_date') || request()->has('from_order_date') || request()->has('to_order_date') || request()->has('order_number') || request()->has('invoice_number') || request()->has('min_nominal') || request()->has('max_nominal') || request()->has('outstanding_status'))
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('analytics.finance.shopee') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="shopeeTransactionsTable">
                        ...
                        <tr>
                            <td colspan="38" class="text-center py-5">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <p class="text-muted">Belum ada data transaksi pembayaran dari Shopee</p>
                                    <a href="{{ route('finance.shopee.import') }}" class="btn btn-primary mt-2">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('analytics.finance.shopee') }}" method="GET">
                        <div class="row">
...
<style>
    ...
    /* Table Styling */
    #shopeeTransactionsTable {
        border-collapse: separate;
        border-spacing: 0;
    }
    
    #shopeeTransactionsTable tr.order-header {
        background-color: rgba(236, 240, 255, 0.5);
    }
    
    #shopeeTransactionsTable tbody tr:hover {
        background-color: rgba(236, 240, 255, 0.7);
    }
    
    #shopeeTransactionsTable tbody tr td:first-child {
        border-left: 3px solid transparent;
    }
    
    #shopeeTransactionsTable tbody tr.order-header td:first-child {
        border-left: 3px solid #4e73df;
    }
    
    #shopeeTransactionsTable tr td {
        white-space: nowrap;
