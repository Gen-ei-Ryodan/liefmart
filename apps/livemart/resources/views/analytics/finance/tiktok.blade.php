...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h1 class="h3 mb-0 text-gray-800">Analytic Keuangan TikTok Lamourad</h1>
            <p class="text-muted small mb-0">Analisis data transaksi keuangan TikTok Lamourad</p>
        </div>
            ...
            <div class="btn-group shadow-sm" role="group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item" data-export="{{ route('analytics.finance.tiktok.export', request()->all()) }}"><i class="far fa-file-excel me-2"></i>Excel</a></li>
                    </ul>
                </div>
            </div>
        </div>
