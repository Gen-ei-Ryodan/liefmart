...
<div class="container-fluid py-3 animate__animated animate__fadeIn animate__faster">
    ...
    <div class="alert alert-info alert-dismissible fade show shadow-sm" role="alert">
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('finance.shopee2.index') }}" class="btn btn-sm btn-outline-primary ms-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            @if(request()->has('from_date') || request()->has('to_date') || request()->has('from_order_date') || request()->has('to_order_date') || request()->has('order_number') || request()->has('invoice_number') || request()->has('min_nominal') || request()->has('max_nominal') || request()->has('outstanding_status'))
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('analytics.finance.shopee2') }}" class="btn btn-sm btn-outline-secondary">
