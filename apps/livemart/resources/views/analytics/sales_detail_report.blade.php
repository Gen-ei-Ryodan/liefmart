            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="m-0 fw-bold text-primary">
                        <i class="fas fa-clipboard-list me-2"></i>Sales Detail Report
                    </h5>
                    <div>
                        <a href="#" data-export="{{ route('analytics.sales-detail-report.export', request()->query()) }}" class="btn btn-sm btn-success">
...
<style>
    ...
    .platform-shopee { background-color: #EE4D2D; color: white; }
    .platform-tiktok { background-color: #000000; color: white; }
    .platform-offline { background-color: #6B7280; color: white; }
    .platform-unknown { background-color: #6c757d; color: white; }
