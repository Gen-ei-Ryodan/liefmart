@extends('layouts.app')
@section('title', 'Analisis Saldo Masuk Bulanan')
@section('content')
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="m-0 fw-bold text-primary">
                        <i class="fas fa-calendar-alt me-2"></i>Analisis Saldo Masuk Bulanan
                    </h5>
                    <div>
                        <a href="#" data-export="{{ route('analytics.monthly-sales-summary.export', request()->query()) }}" class="btn btn-sm btn-success">
